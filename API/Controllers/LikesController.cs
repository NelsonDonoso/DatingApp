...
public class LikesController(ILikesRepository likesRepository): BaseApiController
{
    ...
    [HttpGet]
    public async Task<ActionResult<IReadOnlyList<Member>>> GetMemberLikes([FromQuery] LikesParms likesParms)
    {
        likesParms.MemberId = User.GetMemberId();
        var members = await likesRepository.GetMemberLikes(likesParms);
